...
<link href="resources/css/order/payment.css" rel="stylesheet"
	type="text/css">
<!--  <style>태그 payment.css로 이동(23.08.02.) -->
...
<body>
	<main>
		<div class="complete_msg">
			<img src="${contextPath}/resources/image/order/complete.png" />		<!--  이미지 추가(23.08.02.) -->
			<p id="h1">${user.userId }님의 <b>주문이 완료</b>되었습니다.</p>					<!--  텍스트 수정(23.08.02.) -->
		</div>

		<!-- <p class="h3">주문 정보</p> -->														<!--  주석 처리(23.08.02.) -->
		<div class="info-block to">
			...
			<div class="line line-orderNum">															<!--  클래스명 추가(23.08.02.) -->
				<div class="line-title">
